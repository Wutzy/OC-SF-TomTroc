            ...
            <div>
                ...
                <div class="searchBar">
                    ...
                    <form action="index.php?action=ourBooks" method="POST">
                        <label for="searchBook" class="hidden-label">recherche</label>
                        <input type="text" title="rechercher un livre" placeholder="Rechercher un livre" name="searchBook" id="searchBook" value="">
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="card-book">
                    <a class="info" href="index.php?action=showBook&id=<?= $book->getId() ?>">
                        ...
                        <?php if(!$book->availability) { ?>
                            <span class="unavailable-badge">non dispo.</span>
                        <?php } ?>
